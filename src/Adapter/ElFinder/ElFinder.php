...
class ElFinder
{
    ...
    protected function getNetVolumes()
    {
        if (isset($_SESSION[$this->netVolumesSessionKey])) {
            if ($data = self::sessionDataDecode($_SESSION[$this->netVolumesSessionKey], 'array')) {
                return $data;
            }
        }
    ...
    protected function saveNetVolumes($volumes)
    {
        // try session restart
        @session_start();
        $_SESSION[$this->netVolumesSessionKey] = self::sessionDataEncode($volumes);
        self::sessionWrite();
    }
