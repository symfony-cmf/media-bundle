...
namespace Symfony\Cmf\Bundle\MediaBundle\Tests\Unit\DependencyInjection;
...
class XmlSchemaTest extends XmlSchemaTestCase
{
    public function testSchema()
    {
        ...
        $this->assertSchemaAcceptsXml($xmlFiles, __DIR__.'/../../../src/Resources/config/schema/media-1.0.xsd');
    }
}
